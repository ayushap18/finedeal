...
export declare enum MatchLevel {
    EXACT_ID = "EXACT_ID",
    EXACT = "EXACT",
    HIGH = "HIGH",
    MEDIUM = "MEDIUM",
 ...
 */
export type MessageType = 'GET_PRODUCT_INFO' | 'GET_SEARCH_RESULTS' | 'WAIT_FOR_PAGE_READY' | 'START_COMPARISON' | 'UPDATE_PROGRESS' | 'COMPARISON_COMPLETE' | 'ERROR' | 'SHOW_PRICE_DROP_NOTIFICATION';
